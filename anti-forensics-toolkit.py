    ...
    try:
        if choice == "1":
            ...
            if confirm == "y":
                ...
                print("All files have been deleted. Returning to menu...\n")
                menu()
            else:
                menu()
            ...
            if confirm == "y":
                ...
                print("File opening artifacts Deleted. Returning to menu...\n")
                menu()
            else:
                menu()
            menu()
            ...
            if confirm == "y":
                ...
                print("USB history Deleted. Returning to menu...\n")
                menu()
            else:
                menu()
            menu()
        ...
        #     menu()
            ...
            if confirm == "y":
                ...
                print("Browser Artifacts Deleted. Returning to menu...\n")
                menu()
            else:
                menu()
            menu()
